...
const definitions = [
 ['rest','지침 · 부담 · 쉼',/낙심|지치|지쳐|지쳤|지친|피곤|번아웃|소진|버겁|버거|부담|힘들|힘든|무기력|아무\s*것도\s*하(?:기|고)\s*싫|쉬고\s*싶|잠을?\s*못/],
 ...
 ['future','미래 · 진로 · 선택',/미래|진로|선택|앞날|취업|면접|이직|결정|어떻게\s*될|고민(?:이\s*(?:되|돼)|돼|이에)|어떻게\s*해야\s*할지\s*모르|어느\s*쪽이\s*맞는지\s*모르|방향을\s*모르/],
